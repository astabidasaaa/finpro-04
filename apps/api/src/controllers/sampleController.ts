...
export class SampleController {
  public async getSampleData(req: Request, res: Response) {
    // const sampleData = await prisma.sample.findMany();
    // return res.status(200).send(sampleData);
  }

  public async getSampleDataById(req: Request, res: Response) {
    // const { id } = req.params;
  ...
  public async createSampleData(req: Request, res: Response) {
