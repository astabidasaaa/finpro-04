  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Tambah Promosi Gratis Produk</DialogTitle>
          <div />
          <DialogDescription>
            Promosi gratis produk akan ditampilkan pada saat kustomer melihat
            pilihan produk dan otomatis diberikan saat pemesanan selama jangka
            waktu promosi berlangsung. Buat promosi gratis produk anda disini.
          </DialogDescription>
        </DialogHeader>
        <CreatePromotionForm
          setIsOpen={setIsOpen}
